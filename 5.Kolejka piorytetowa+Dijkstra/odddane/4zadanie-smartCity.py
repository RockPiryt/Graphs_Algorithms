...
if __name__ == "__main__":
    ...
    print("Punkty artykulacyjne:", articulation_points)
    print("\n\n")
    ...
    print("Macierz najkrótszych czasów dojazdów:")
