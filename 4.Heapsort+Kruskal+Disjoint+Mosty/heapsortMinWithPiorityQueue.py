...
def heap_sort_with_priority_queue(unsorted_list):
    # Tworzymy kopiec o pojemności równej długości listy
    priority_queue = MinHeap(len(unsorted_list))
    
    # Wstawiamy wszystkie elementy z listy do kopca
    for element in unsorted_list:
        priority_queue.insertHeap(element)
    
    # Wyciągamy elementy z kopca w porządku rosnącym
    sorted_list = []
    while priority_queue.size > 0:
        sorted_list.append(priority_queue.removeFromHeap())
...
if __name__ == "__main__":
    ...
    sorted_list = heap_sort_with_priority_queue(unsorted_list)
